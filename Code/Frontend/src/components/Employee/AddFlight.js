...
class AddFlight extends Component {
    ...
    axios
      ...
      .then((response) => {
        ...
        for (var i = 0; i < response.data.length; i++) {
          ...
          htmlSource +=
            "<option value = '" +
            response.data[i].country_id +
            "'>" +
            response.data[i].country_name +
            '</option>';
          htmlDestination +=
            "<option value = '" +
            response.data[i].country_id +
        ...
        document.getElementById('dropdownDestination').innerHTML =
          htmlDestination;
        document.getElementById('dropdownSourceCity').innerHTML =
          htmlSourceCity;
        document.getElementById('dropdownDestinationCity').innerHTML =
          htmlDestinationCity;
          ...
          axios
            ...
            .then((response) => {
              ...
              if (response.status === 200) {
                ...
                var htmlAircrafts =
                  document.getElementById('dropdownAircraft').innerHTML;
                for (var i = 0; i < response.data.length; i++) {
                  htmlAircrafts +=
                    '<option value = ' +
                    response.data[i].aircraft_id +
                    '>' +
                    response.data[i].aircraft_model +
                    '</option>';
                }
  ...
  checkValidation = () => {
    ...
    const desAirportId = document.getElementById(
  ...
  onChangeSourceCountry = (e) => {
    ...
    if (
      ...
      return;
    const src = this.state.countryCityBinding.get(
      parseInt(document.getElementById('dropdownSource').value)
    );
    const des = this.state.countryCityBinding.get(
      parseInt(document.getElementById('dropdownDestination').value)
    );
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div id='divBorder'>
          <label
            style={{ fontSize: '32px', marginBottom: '3%', marginLeft: '1%' }}
          >
            Add Flight
          </label>
          <table id='tblCreateFlight'>
            <tr>
              ...
              <td>
                ...
                <select
                  id='dropdownSource'
                  onChange={this.onChangeSourceCountry}
                ></select>
              </td>
            </tr>
            <tr>
            ...
            <tr class='hiddenElements' style={{ display: 'none' }}>
              ...
              <td>
                <select
                  id='dropdownSourceCity'
                  onChange={this.onChangeSourceCity}
                ></select>
              </td>
            </tr>
            <tr class='hiddenElements' style={{ display: 'none' }}>
          ...
          <button id='btnCreateFlight' onClick={this.createFlight}>
            Add Flight
          </button>
        </div>
      </div>
