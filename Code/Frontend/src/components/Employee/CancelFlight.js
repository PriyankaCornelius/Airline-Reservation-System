...
class CancelFlight extends Component {
  ...
  onChangeFlightnum = () => {
    ...
    html += '<tr><td>Flight Price:</td><td><label>' + arr.flight_price + '</label></td><tr/>';
    html += "</table><br/>";
    html += '<button id = "btnCancelFlight">Cancel Flight</button>';
    document.getElementById('divFlightDetails').innerHTML = html;
    document.getElementById('divFlightDetails').style.display = '';
    document.getElementById('btnCancelFlight').onclick = this.cancelFlight;
